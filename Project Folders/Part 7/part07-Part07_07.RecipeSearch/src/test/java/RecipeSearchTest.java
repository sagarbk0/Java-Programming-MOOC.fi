...
public class RecipeSearchTest {
    ...
    public void test(List<String> fileContents, List<String> commandList, List<String> expectedPrints, List<String> notExpectedPrints) throws FileNotFoundException {
